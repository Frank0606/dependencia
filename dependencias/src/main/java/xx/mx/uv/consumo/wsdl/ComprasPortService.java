 ...
 * 
 */
@WebServiceClient(name = "comprasPortService", targetNamespace = "t4is.uv.mx/compras", wsdlLocation = "https://compras-production-e1a8.up.railway.app/ws/compras.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://compras-production-e1a8.up.railway.app/ws/compras.wsdl");
